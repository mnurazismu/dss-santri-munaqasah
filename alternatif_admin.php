        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            ...
            <div class="bg-gray-100 p-4 rounded-lg mt-8 flex flex-col">
                <div class="mb-2 flex justify-end">
                    <a href="tambah_alternatif_admin.php"><button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    ...
    <script type="text/javascript">
        ...
        function deleteItem(confirmDelete) {
            if (confirmDelete) {
                ...
                window.location.href = "./hapus_alternatif_admin.php?id=<?= $value['id_alternatif'] ?>";
            } else {
