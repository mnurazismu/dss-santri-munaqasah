...
<body class="font-['Inter'] bg-gray-100 flex min-h-screen justify-center items-center">
    <div class="w-1/2 shadow-md bg-white rounded-md py-12 my-12">
        <form class="max-w-sm mx-auto lg:min-w-full px-12" action="" method="post">
            <h1 class="mb-2 text-2xl font-extrabold tracking-tight leading-none text-gray-900 dark:text-white text-shadow">Form Tambah Sub Kriteria</h1>
                ...
                for ($i = 1; $i <= $jumlah_subkriteria; $i++) {
                    echo '
                                    ...
                                    <div class="flex items-center mb-4 w-full">
                                        ...
                                        <input name="subkriteria_' . $i . '" id="subkriteria_' . $i . '" placeholder="Sub Kriteria ' . $i . '" required type="text" autocomplete="off" class="w-4/6 px-4 py-2 h-11 border border-blue-400 rounded-lg focus:outline-offset-4 focus:outline-secondary">
                                    </div>
