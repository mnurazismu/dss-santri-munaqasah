...
<body class="font-['Inter'] bg-gray-100 flex min-h-screen justify-center items-center">
    <div class="w-1/3 shadow-md bg-white rounded-md py-12">
        <form class="max-w-sm mx-auto lg:min-w-96" action="" method="post">
            <h1 class="mb-2 text-2xl font-extrabold tracking-tight leading-none text-gray-900 dark:text-white text-shadow">Form Ubah Kriteria</h1>
            ...
            <div class="mb-5">
                ...
                <div class="flex items-center ps-4 border border-gray-200 rounded-lg dark:border-gray-700 mb-1">
                    <input id="benefit" type="radio" value="Benefit" name="jenis_kriteria" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" <?php if (isset($row['jenis_kriteria']) && $row['jenis_kriteria'] === 'Benefit') echo 'checked'; ?>>
            ...
            <div class="mb-5">
                ...
                <div class="relative">
                    <input type="number" id="jumlah_subkriteria" name="jumlah_subkriteria" value="<?= $total_subkriteria ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Jumlah Sub Kriteria" required autocomplete="off" min="1" max="5" />
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    </div>
                </div>
            </div>
