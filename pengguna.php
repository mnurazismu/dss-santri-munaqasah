        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <div class="flex justify-between">
                <div>
                    ...
                    <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Data Pengguna</h1>
                </div>
            </div>
                        ...
                        <tbody>
                            <?php foreach ($user as $key => $value) : ?>
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex">
                                            <a href="./ubah_pengguna.php?id_user=<?= $value['id_user'] ?>"><button type="button" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm p-2 text-center inline-flex items-center me-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
    ...
    <script type="text/javascript">
        ...
        function deleteItem(confirmDelete) {
            if (confirmDelete) {
                ...
                window.location.href = "./hapus_pengguna.php?id_user=<?= $value['id_user'] ?>";
            } else {
